...
def add_training_params(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        '--data_dir',
        # default=None,
        default='dataset/Chunyu/processed_add_category_add_state',
        type=str,
        help='File pattern for the train set.')
    parser.add_argument(
        '--train_file',
    ...
    # parser.add_argument(
    #     '--dev_file',
    #     default='dataset/Chunyu/processed_add_category_add_state/test.json',
    #     type=str,
    #     help='File pattern for the dev set.')
    # parser.add_argument(
    #     '--dev_file',
    ...
    #     '--output_dir',
    #     type=str,
    #     default='dataset/Chunyu/exp_t5_base_chinese_add_category_add_state',
    #     help='Output directory for checkpoints.')
    # parser.add_argument(
    #     '--log_dir',
    #     type=str,
    #     default='dataset/Chunyu/exp_t5_base_chinese_add_category_add_state/log',
    #     help='Output directory for checkpoints.')
